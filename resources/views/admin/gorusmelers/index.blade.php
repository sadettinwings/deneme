...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Gorusmeler">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($gorusme_kategoris as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.gorusmelers.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'musteri_sec_2_musteri_adi', name: 'musteri_sec_2.musteri_adi' },
{ data: 'gorusen_kisi_name', name: 'gorusen_kisi.name' },
{ data: 'not', name: 'not' },
{ data: 'kategori_kategori', name: 'kategori.kategori' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Gorusmeler').DataTable(dtOverrideGlobals);
