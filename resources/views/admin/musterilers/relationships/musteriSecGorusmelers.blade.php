...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-musteriSecGorusmelers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.gorusmeler.fields.musteri_sec') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($gorusmelers as $key => $gorusmeler)
                        <tr data-entry-id="{{ $gorusmeler->id }}">
                            ...
                            <td>
                                {{ $gorusmeler->musteri_sec->musteri_adi ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-musteriSecGorusmelers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
